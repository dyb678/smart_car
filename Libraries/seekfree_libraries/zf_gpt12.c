...
void gpt12_mux(GPTN_enum gptn, GPT_PIN_enum count_pin, GPT_PIN_enum dir_pin)
{
	...
	switch(gptn)
	{
		case GPT12_T2:
		{
			if	    (GPT12_T2INB_P33_7 == count_pin)	count = &IfxGpt120_T2INB_P33_7_IN;
			else	ZF_ASSERT(FALSE);

			if	    (GPT12_T2EUDB_P33_6 == dir_pin)		dir = &IfxGpt120_T2EUDB_P33_6_IN;
			else	ZF_ASSERT(FALSE);
		}break;
		...
		case GPT12_T4:
		{
			...
			if	    (GPT12_T4EUDB_P33_5 == dir_pin)		dir = &IfxGpt120_T4EUDB_P33_5_IN;
			else	ZF_ASSERT(FALSE);
		}break;
