...
void spi_mux(SPIN_enum spi_n, SPI_PIN_enum sck_pin, SPI_PIN_enum mosi_pin, SPI_PIN_enum miso_pin, SPI_PIN_enum cs_pin, IfxQspi_SpiMaster_Pins *set_pin, IfxQspi_SpiMaster_Output *set_cs)
{
	...
	switch(spi_n)
	{
		...
		case SPI_1:
		{
			...
			//else if (SPI1_SCLK_P10_2 == sck_pin)    set_pin->sclk = &IfxQspi1_SCLK_P10_2_OUT;
			else	ZF_ASSERT(FALSE);

		    if      (SPI1_MOSI_P10_3 == mosi_pin)   set_pin->mtsr = &IfxQspi1_MTSR_P10_3_OUT;
			//else if (SPI1_MOSI_P10_1 == mosi_pin)   set_pin->mtsr = &IfxQspi1_MTSR_P10_1_OUT;
			//else if	(SPI1_MOSI_P11_8 == mosi_pin)	set_pin->mtsr = &IfxQspi1_MTSR_P11_8_OUT;
			...
			//else if (SPI1_MISO_P10_1 == miso_pin)   set_pin->mrst = &IfxQspi1_MRSTA_P10_1_IN;
			else	ZF_ASSERT(FALSE);
			...
			//else if (SPI1_CS8_P11_8   == cs_pin)	set_cs->pin = &IfxQspi1_SLSO10_P11_8_OUT;
		...
		case SPI_2:
		{
			...
			//else if (SPI2_SCLK_P13_0  == sck_pin)   set_pin->sclk = &IfxQspi2_SCLK_P13_0_OUT;
			...
			//else if (SPI2_MOSI_P13_3  == mosi_pin)  set_pin->mtsr = &IfxQspi2_MTSR_P13_3_OUT;
