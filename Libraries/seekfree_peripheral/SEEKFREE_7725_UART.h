...
#define OV7725_COF_UART_TX     	UART1_TX_P15_0
#define OV7725_COF_UART_RX     	UART1_RX_P15_1

#define OV7725_UART_VSYNC_PIN 	ERU_CH4_REQ8_P33_7  //场中断引脚	可选范围参考ERU_PIN_enum枚举 不可与像素引脚选择为同一个通道，或者是共用中断的通道
													//例如场中断选择ERU_CH3 那么像素引脚就不能选择ERU_CH7，因为3和7的中断是共用的。

#define OV7725_UART_DATA_PIN  	P02_0  				//定义D0数据引脚  假设D0定义为P00_0 那么D1所使用的引脚则为P00_1，依次类推
													//可设置参数P00_0、P02_0、P15_0，不能设置为其他参数

#define OV7725_UART_PCLK_PIN  	ERU_CH6_REQ12_P11_10//定义像素时钟引脚 可选范围参考ERU_PIN_enum枚举 不可与场中断引脚选择为同一个通道，或者是共用中断的通道
													//例如场中断选择ERU_CH3 那么像素引脚就不能选择ERU_CH7，因为3和7的中断是共用的。

#define OV7725_UART_DMA_CH		IfxDma_ChannelId_5	//定义使用的DMA通道 0-16可选  通道号越大优先级越低
